...
public class BarraSuperiorEnJuego extends JPanel {
    ...
    private void initComponents() {
        ...
        botonGuardarTablero.setText("Guardar Tablero");
        botonGuardarTablero.setToolTipText("GuardarTablero");
        botonGuardarTablero.addActionListener(new ActionListener() {

            public void actionPerformed(ActionEvent e) 
            {
                Controlador.obtenerInstancia().guardarTablero();
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(botonIniciar)
                    .addGap(35, 35, 35)
                .addComponent(botonGuardarTablero)
