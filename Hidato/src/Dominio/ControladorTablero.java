...
public class ControladorTablero {
    ...
    /* EXC 'IOException': Excepcion de entrada/salida */
    public int confirmarTableroPropuesto(String nombre, int topologia, int[][] contenido) throws Exception {
    ...
    /* EXC 'IOException': Excepcion de entrada/salida */
    public List<Object[]> obtenerListaTableros(int opciones)
      throws Exception {
